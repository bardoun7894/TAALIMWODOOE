...
Partial Public Class Database1DataSet
    ...
    Partial Public Class StudentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddStudentRow(ByVal name As String, ByVal age As Integer, ByVal StudentID As String) As StudentRow
            Dim rowStudentRow As StudentRow = CType(Me.NewRow,StudentRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, name, age, StudentID}
    ...
    Partial Public Class StudentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name"& _ 
                "` = ?)) AND ((? = 1 AND `age` IS NULL) OR (`age` = ?)) AND ((? = 1 AND `StudentI"& _ 
                "D` IS NULL) OR (`StudentID` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Student` (`name`, `age`, `StudentID`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Student` SET `name` = ?, `age` = ?, `StudentID` = ? WHERE ((`ID` = ?) AND"& _ 
                " ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `age` IS NULL) OR "& _ 
                "(`age` = ?)) AND ((? = 1 AND `StudentID` IS NULL) OR (`StudentID` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.TaalimWodooe.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, name, age, StudentID FROM Student"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_name As String, ByVal Original_age As Global.System.Nullable(Of Integer), ByVal Original_StudentID As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_StudentID,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal name As String, ByVal age As Global.System.Nullable(Of Integer), ByVal StudentID As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal name As String, ByVal age As Global.System.Nullable(Of Integer), ByVal StudentID As String, ByVal Original_ID As Integer, ByVal Original_name As String, ByVal Original_age As Global.System.Nullable(Of Integer), ByVal Original_StudentID As String) As Integer
            If (name Is Nothing) Then
            ...
            If (Original_age.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_age.Value,Integer)
            Else
